...
async function extractPdfText(filePath:string, options?:PDFExtractOptions) {
    const content = []
    return await new Promise((resolve, reject) => {
        ...
        return content
    }).then(data => console.log(content[1]))
}
console.log(extractPdfText('trademark_gazette.pdf'))
