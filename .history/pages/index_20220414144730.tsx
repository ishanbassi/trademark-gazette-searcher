...
const  App:FunctionComponent  = (props) =>  {
    ...
    const [searchErr , setSearchErr] = useState<File>()
    ...
    const fileUpload =   async (xlsFile:File) => {
        ...
        const result =  fetch('/api/fileReader', {method:'POST', body:JSON.stringify(tmClassArr)})
        .then(res => setSearchRes(res.json()))
    ...
    return(
        <>
            <Container className="text-center">
                ...
                <FileUploader handleChange={fileUpload}  name="excelFile"  types={['xls', ]} classes="drag-and-drop-box"/>
            </Container>
            <Container>
            {
                searchRes ? 
