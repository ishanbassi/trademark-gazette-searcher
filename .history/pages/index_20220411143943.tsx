                ...
                {searchRes ? searchRes.map((tm, i) => {
                    return(
                        <tr key={`${tm.trademark}_${i}`}>
                            <td className="tm-no-col">{i}</td>
                            <td className="tm-col">{tm.trademark}</td>
                            <td className="tm-details-col">{tm.details}</td>
                            <td className="tm-pdf-col">{tm.page_no}</td>
                            <td className="tm-class-col">{tm.tm_class}</td>
