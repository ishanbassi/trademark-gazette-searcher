...
const  App:FunctionComponent  = (props) =>  {
    ...
    const journals = useRef({journal_no:null, total_journals:null})
    ...
    useEffect( () => {
        ...
        if(loading) {
            ...
            journals.current.journal_no -= 1
            journals.current.total_journals -= 1
        }
    },[loading]
    ...
    return(
        <>
            ...
            {journals.current.total_journals > 0 ? 
             <Container  fluid="md" className="text-center mt-2">
                <Button
