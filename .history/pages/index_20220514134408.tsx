    ...
    return(
        <>
            ...
            <div>
                    ...
                    <Form.Select id="journals" size="sm" onChange={() => setLoading(true)} disabled={loading ? true : false} ref={journalRef}>
                        {journals.map((journal, i) => {
                            let journal_no = journal.journal_no
                            return(
                                <option value={journal_no} key={`${journal_no}_${i}`} selected={i == 0 ? true : false}>{journal_no}</option>
                            )
                        })}
                    </Form.Select>
                </div>
