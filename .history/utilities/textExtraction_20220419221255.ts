        ...
        pdfExtract.extract(filePath,options,  (err, data) => {
            ...
            data.pages.forEach( (page, i) =>{
                ...
                page.content.forEach( (data,i) => {
                    ...
                    if (data.height >= 23 && data.height <= 24 ){
...
extractPdfText('./pdfs/journal 2044/trademark_gazette.pdf').then(async res => await promises.writeFile('pdf2.json', JSON.stringify(res)) ).catch(err => console.log(err))