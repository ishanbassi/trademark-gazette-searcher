...
extractPdfText('./pdfs/journal 2047/trademark_gazette(1-6).pdf').then(async res => await promises.writeFile('pdf1.json', JSON.stringify(res)) ).catch(err => console.log(err))