...
extractPdfText('./pdfs/journal 2047/document2.pdf').then(async res => await promises.writeFile('pdf1.json', JSON.stringify(res))).catch(async err => console.log( await err))