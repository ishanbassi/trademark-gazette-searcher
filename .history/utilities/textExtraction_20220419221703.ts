...
extractPdfText('./pdfs/journal 2044/trademark_gazette.pdf').then(async res => await promises.writeFile('pdf14.json', JSON.stringify(res)) ).catch(err => console.log(err))